...
$typeinfo = Array(0=>'参战者',1=>'董事长',2=>'全息幻象',3=>'各路党派',4=>'非作战人员',5=>'代码聚合体',6=>'黑幕',7=>'首席执行官',8=>'管理员',9=>'活动盔甲');
$killmsginfo = Array(0=>'',1=>'你还不懂得运用你的力量，咱为此感到惋惜。',2=>'猎杀任务执行中。',3=>'真弱。',4=>'啊……对不起！对不起！',5=>'记住，轻敌可是会死的。',6=>'忘记历史就意味着背叛，背叛就意味着……死亡。',7=>'你的实力还远远不及董事长的脚根呢。',8=>'死吧。',9=>'Let the darkness DIE!!');
$lwinfo = Array(
	0 => '',
	1 => '呜……这个躯体……咱还是无法自由运用啊……',
	2 => '机体受损过重，任务被迫中止。',
...
$plsinfo = Array('管理后台','音乐区','RF高校','雪之镇','动画区','ACFUN贴吧','圣Gradius学园','清水池','白穗神社','墓地','娱乐区','对天使用作战本部','夏之镇','游戏区','光坂高校','柊家神社','常磐森林','M记戈壁','秋之镇','常磐镇医院','春之镇','专辑区','初始之树','幻想世界','永恒的世界','Hut of Amarillo','键刃墓场','花菱商厦','FARGO前基地','风祭森林');
$xyinfo = Array('D-6','A-2','B-4','C-3','C-4','C-5','C-6','D-4','E-2','E-4','F-6','E-8','F-2','F-9','G-3','G-6','H-4','H-6','I-6','I-7','I-10','J-6','F-2','I-1','J-10','A-1','A-10','D-2','I-2','G-4');
$areainfo = Array
	(
	...
	"表面上看去像是标准的贵族女校，<br>有着与学校不相称的停机坪和地下仓库。<br>",
	...
	"代表光与暗的战士们曾经战斗过的战场，<BR>现在只有他们留下的武器诉说着战争的结局。<br>",
	"这个商厦的顶楼是一个星象馆。<BR>但是这里已经空无一人……<br>",
	"现在已经是一团废墟的遗迹。<BR>可能能找到有用的物品也说不定。<br>",
	"传说有神秘力量的森林。<BR>谁知道这个地方会出现什么。<br>"
);
