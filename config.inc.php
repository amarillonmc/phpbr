...
$dbname = 'acbra300a';			// database name
						// 数据库名
...
$gamefounder = '';			// super administrator's UID
...
$allowreg = 0;			// allow register, 0=No, 1=Yes
						// 模板自动刷新开关 0=关闭, 1=打开, 在不修改页面的情况下可以关闭

$bbsurl = '';    //the bbs url for the game plus
									//安装游戏插件的论坛地址

$gameurl = 'http://localhost/acbra299/';    // the url of game program files,for the full-window mode
									//游戏程序地址，用于全屏模式
