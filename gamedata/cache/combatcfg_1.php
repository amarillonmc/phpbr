...
//各种攻击方式的基础命中率
$hitrate_obbs = Array('N' => 80, 'P' => 80, 'K' => 75, 'G' => 70, 'C' => 70, 'D' => 55, 'F' => 90);
...
$hitrate_r =  Array('N' => 0.025, 'P' => 0.025, 'K' => 0.025, 'G' => 0.05, 'C' => 0.25, 'D' => 0.020, 'F'=> 0.02);
...
$ex_good_club = Array('p' => 8,'w'=>7);
//各种属性攻击的克制属性
$ex_dmg_def = Array('p' => 'q', 'u' => 'U', 'i'=>'I','d' => 'D','e' => 'E','w'=>'W');
//各种属性攻击的基础伤害值
$ex_base_dmg = Array('p' => 15, 'u' => 25, 'i'=> 5, 'd'=> 1,'e' => 15,'w' => 20);
//各种属性攻击的最大伤害值，游戏中，属性攻击伤害不会超过这个参数，0则不限制伤害
$ex_max_dmg = Array('p' => 90, 'u' => 120, 'i'=> 60, 'd'=> 0,'e' => 100,'w' => 100);
...
//已经进入异常状态对属性攻击伤害的影响
$ex_inf_punish = Array('p' => 2, 'u' => 1, 'i'=> 0.5,'e' => 1,'w'=>1.5);
//各种属性攻击的初始致异常状态率
