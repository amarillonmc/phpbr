...
$mixinfo = array
	...
	array('class' => 'h', 'stuff' => array('治疗针','体力回复药','蒸馏水'),'result' => array('特级恢复药','HB',100,3,),),	
	array('class' => 'h', 'stuff' => array('甜生姜','地雷酥糖'),'result' => array('曾经的荣光-橙黄','HB',50,1,),),
	array('class' => 'h', 'stuff' => array('曾经的荣光-橙黄','面包'),'result' => array('该物品不存在！','HB',300,8,'Z'),),
	...
	array('class' => 'wd', 'stuff' => array('★炸药★','水鸳鸯'),'result' => array('★C4★','WD',300,20,'d'),),
	...
	array('class' => 'pokemon', 'stuff' => array('《小黄的精灵球》','《小黄的收服特训》'),'result' => array('《小黄的超级球》','WC',233,'∞','Zur'),),
	...
	array('class' => 'pokemon', 'stuff' => array('《小黄的收服特训》(下)','《小黄的收服特训》(上)'),'result' => array('《小黄的收服特训》','X',1,1,),),
	array('class' => 'pokemon', 'stuff' => array('凤凰之羽','露琪亚之羽','《小黄的超级球》','《小黄的收服集训》'),'result' => array('《小黄的大师球》','WC',386,'∞','Zcrd'),),
	...
	array('class' => 'wf', 'stuff' => array('空白符卡','★制御棒★','向日葵'),'result' => array('『地狱的人造太阳』','WF',420,'∞','d'),),
	...
	array('class' => 'wf', 'stuff' => array('金符「Metal Fatigue」','火符「Agni Shine」','《魔女的魔导书》'),'result' => array('火&金符『St. Elmo Pillar』','WF',300,'∞','ndfc'),),
	array('class' => 'wf', 'stuff' => array('水符『Jerry Fish Princess 』','月符「Silent Serena」','消音器','天然水'),'result' => array('水&月符『Silent Deluge』','WF',233,'∞','kZz'),),
	array('class' => 'wf', 'stuff' => array('火符「Agni Shine」','水符「Princess Undine」','木符『Sylphy Horn』','金符「Metal Fatigue」','土符「Lazy Trilithon」'),'result' => array('『贤者之石』-劣','WF',500,'∞','d'),),
	array('class' => 'wf', 'stuff' => array('『贤者之石』-劣','《魔女的魔导书》'),'result' => array('火水木金土符『贤者之石』','WF',5000,'∞','uipwe'),),
	array('class' => 'wf', 'stuff' => array('火水木金土符『贤者之石』','日&月符『Royal Diamond Ring』'),'result' => array('月月火水木金金符『年中无休』（笑）','WF',65500,'∞','rd'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「隼骑士」-仮','☆四星认证☆'),'result' => array('「隼骑士」','WC',100,'∞','rj'),),
	...
	array('class' => 'ocg', 'stuff' => array('『奥西里斯之天空龙』','『欧贝利斯克之巨神兵』','『太阳神之翼神龙』'),'result' => array('◎光之创造神◎','WC',65535,'∞','AcrdZ'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子龙」 ★5','「电子龙」 ★5','「电子龙」 ★5'),'result' => array('「电子终结龙」','WC10',256,'∞','Nnrc'),),
	...
	array('class' => 'ocg', 'stuff' => array('水灵使-艾莉娅 ★3','☆四星认证☆'),'result' => array('凭依装着-艾莉娅 ★4','WC',160,'60','ij'),),
	...
	array('class' => 'ocg', 'stuff' => array('红莲魔龙 ★8 -仮','☆八星认证☆'),'result' => array('红莲魔龙 ★8','WC08',500,'30','cdu'),),
	array('class' => 'ocg', 'stuff' => array('红莲魔龙 ★8','☆爆裂模式☆'),'result' => array('真红魔龙/爆裂体 ★10','WC10',250,'∞','cdZ'),),
	array('class' => 'ocg', 'stuff' => array('星尘龙 ★8','☆爆裂模式☆'),'result' => array('星尘龙/爆裂体 ★10','WC10',512,'∞','mr'),),
	array('class' => 'ocg', 'stuff' => array('正义盟军 光明守望者 ★8 -仮','☆八星认证☆'),'result' => array('正义盟军 光明守望者 ★8','WC08',260,'∞','rZ'),),
	array('class' => 'ocg', 'stuff' => array('救世魔龙 -仮','☆十星认证☆'),'result' => array('「救世魔龙」 ★10','WC10',875,'∞','uf'),),
	...
	array('class' => 'hidden', 'stuff' => array('面包','矿泉水','女生校服'),'result' => array('Untainted Glory','A',1,1,'Z'),),
	array('class' => 'hidden', 'stuff' => array('面包','矿泉水','男生校服'),'result' => array('Untainted Glory','A',1,1,'Z'),),
	...
	//array('class' => 'hidden', 'stuff' => array('生命之源','微小日常之爱恋'),'result' => array('【恋歌】','ss',98,98,'Z'),),
	);
?>