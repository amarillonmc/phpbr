...
$typeinfo = Array(0=>'参战者',1=>'红杀将军',2=>'全息幻象',3=>'各路党派',4=>'拟似意识',5=>'代码聚合体',6=>'黑幕',7=>'幻影执行官',8=>'管理员',9=>'红杀菁英',10=>'',11=>'真职人',12=>'未名存在',13=>'循环使者',14=>'数据碎片',15=>'数据碎片',16=>'数据碎片');
$killmsginfo = Array(0=>'',1=>'任务完结。',2=>'猎杀任务执行中。',3=>'你弱爆了！',4=>'………………',5=>'记住，轻敌可是会死的。',6=>'忘记历史就意味着背叛，背叛就意味着……死亡。',7=>'你的实力还远远不及董事长的脚根呢。',8=>'死吧。',9=>'MISSION COMPLETE',10=>'这是我必须做的事，给您添麻烦了……',11=>'看看职人的力量！',12=>'你要反省的事情还有很多。');
