...
$mixinfo = array
	...
	array('class' => 'h', 'stuff' => array('治疗针','体力回复药','蒸馏水'),'result' => array('特级恢复药','HB',100,10,),),	
...
array('class' => 'wk', 'stuff' => array('D.毒针','D.毒针'),'result' => array('D.D.D','WK',100,20,'N'),),
	...
	array('class' => 'wk', 'stuff' => array('『祝福宝石』','『风魔激光刃』'),'result' => array('Azurewrath','WK',1,9999,'Nrci'),),
	...
	array('class' => 'wg', 'stuff' => array('老式火枪','原型武器G','定时炸弹','某种电子零件'),'result' => array('★发条式突击步枪★','WG',110,200,'r'),),
	...
	array('class' => 'wd', 'stuff' => array('★炸药★','水鸳鸯'),'result' => array('★C4★','WD',150,40,'d'),),
	array('class' => 'wd', 'stuff' => array('探测器电池','打火机'),'result' => array('☆自爆电池☆','WD',140,32,'d'),),
	array('class' => 'wd', 'stuff' => array('自爆电池','电磁IED','脉冲防线'),'result' => array('脉冲蓄电池','WD',150,60,'ed'),),
	array('class' => 'wd', 'stuff' => array('自爆电池','辐射IED','★阔剑地雷★'),'result' => array('辐射蓄电池','WD',220,60,'pd'),),
	array('class' => 'wd', 'stuff' => array('伏特加','一杯八分满的啤酒'),'result' => array('深水炸弹『depth charge』','WD',133,45,'d'),),
	array('class' => 'wd', 'stuff' => array('深水炸弹『depth charge』','火药'),'result' => array('莫洛托夫鸡尾酒','WD',140,60,'ud'),),
	array('class' => 'wd', 'stuff' => array('咖啡酒','百利甜','伏特加'),'result' => array('奇怪的三色饮料','HB',133,2),),
	array('class' => 'wd', 'stuff' => array('奇怪的三色饮料','打火机','杯子'),'result' => array('B-52轰炸机','WD',140,80,'ud'),),
	array('class' => 'wd', 'stuff' => array('密封的酒瓶','★阔剑地雷★','莫洛托夫鸡尾酒'),'result' => array('凝固汽油弹','WD',100,300,'urdZ'),),
	array('class' => 'wd', 'stuff' => array('密封的酒瓶','★阔剑地雷★','B-52轰炸机'),'result' => array('凝固汽油弹','WD',100,200,'urdZ'),),
	...
	array('class' => 'wd', 'stuff' => array('★血腥玛丽★Bloody Mary','★公牛子弹★Bull Shot','密封的酒瓶'),'result' => array('★血腥公牛★Bloody Bull','WD',450,450,'dwr'),),
	array('class' => 'wd', 'stuff' => array('蒸馏水','天然水','一氧化二氢'),'result' => array('★水★','HS',573,10,''),),
	array('class' => 'wd', 'stuff' => array('★水★','★时停怀表★'),'result' => array('★BIU★','WD',240,70,'Nn'),),
	array('class' => 'wd', 'stuff' => array('★阔剑地雷★','★瓶装幽灵★','某种电子零件'),'result' => array('★幽灵冲击★','WD',250,150,'Nn'),),
	array('class' => 'wd', 'stuff' => array('★幽灵冲击★','《魔女的魔导书》','笔记本电脑'),'result' => array('★BIUBIU★','WD',370,300,'Nnr'),),
	array('class' => 'wd', 'stuff' => array('★BIU★','★BIUBIU★','凝固汽油弹'),'result' => array('★BIUBIUBIU★','WD',400,400,'ZnNdr'),),
	...
	array('class' => 'pokemon', 'stuff' => array('白色的羽毛','金色方块'),'result' => array('凤凰之羽','WK',20,200,'u'),),
        array('class' => 'pokemon', 'stuff' => array('《小黄的收服特训》(上)','《小黄的收服特训》(下)'),'result' => array('《小黄的收服特训》','X','1','1'),),
	array('class' => 'pokemon', 'stuff' => array('白色的羽毛','银色方块'),'result' => array('露琪亚之羽','WK',50,200,'i'),),
	array('class' => 'pokemon', 'stuff' => array('凤凰之羽','露琪亚之羽','《小黄的超级球》'),'result' => array('《小黄的大师球》','WC',649,'∞','criu'),),
	...
	array('class' => 'key', 'stuff' => array('提示纸条K','提示纸条E','提示纸条Y','提示纸条D'),'result' => array('【KEY系生命弹】','WG',860,5,'zd'),),
	...
	array('class' => 'hidden', 'stuff' => array('生命之源','巨大路灯柱'),'result' => array('无尽散花之涅磐','WKP',233,20,'Z'),),
	array('class' => 'hidden', 'stuff' => array('生命之源','黑魔法-权利'),'result' => array('无法推卸的命运','WDG',233,20,'Z'),),
	array('class' => 'hidden', 'stuff' => array('生命之源','『9mm鲁格枪』'),'result' => array('破灭未来的残光','WFK',233,20,'Z'),),
	array('class' => 'hidden', 'stuff' => array('生命之源','红色的丝带'),'result' => array('来自未来的奇迹','WCP',233,20,'Z'),),
	...
	array('class' => 'cube', 'stuff' => array('蓝色方块','蓝色方块','蓝色方块','蓝色方块'),'result' => array('★急冻光线★','WG',152,251,'ric'),),
	...
	array('class' => 'wf', 'stuff' => array('日符「Royal Flare」-劣','《魔女的魔导书》'),'result' => array('日符「Royal Flare」','WF',200,'∞','udc'),),
	array('class' => 'wf', 'stuff' => array('月符「Silent Serena」-劣','《魔女的魔导书》'),'result' => array('月符「Silent Serena」','WF',90,'∞','irc'),),
	array('class' => 'wf', 'stuff' => array('月符「Silent Serena」','日符「Royal Flare」'),'result' => array('日&月符『Royal Diamond Ring』','WF',290,'∞','riud'),),
	array('class' => 'wf', 'stuff' => array('金符「Metal Fatigue」','火符「Agni Shine」','《魔女的魔导书》'),'result' => array('火&金符『St. Elmo Pillar』','WF',280,'∞','ndfc'),),
...
array('class' => 'ocg', 'stuff' => array('「隼骑士」-仮','☆四星认证☆'),'result' => array('「隼骑士」','WC',100,'∞','rj'),),
	...
	array('class' => 'hidden', 'stuff' => array('「真紅眼黑龍」','「金属化·魔法反射装甲」'),'result' => array('「真紅眼黑龍鐵龍」','WC',280,'∞','uA'),),
 ...
 array('class' => 'ocg', 'stuff' => array('「电子龙」-仮','☆五星认证☆'),'result' => array('「电子龙」 ★5','WC05',200,'88','ej'),),
  array('class' => 'hidden', 'stuff' => array('「电子龙」 ★5','「电子龙」 ★5','「电子龙」 ★5'),'result' => array('「电子终结龙」','WC10',400,'∞','Nec'),),
	array('class' => 'ocg', 'stuff' => array('「骷髅指挥」-仮','☆四星认证☆'),'result' => array('「骷髅指挥」 ★4','WC04',150,'∞','rj'),),
	array('class' => 'ocg', 'stuff' => array('「僵尸之主」-仮','☆四星认证☆'),'result' => array('「僵尸之主」 ★4','WC04',100,'180','pj'),),
	array('class' => 'ocg', 'stuff' => array('「死灵之颜」-仮','☆四星认证☆'),'result' => array('「死灵之颜」 ★4','WC04',180,'∞','Zj'),),
	array('class' => 'ocg', 'stuff' => array('「吸血鬼领主」-仮','☆五星认证☆'),'result' => array('「吸血鬼领主」 ★5','WC05',200,'∞','Aj'),),
	array('class' => 'ocg', 'stuff' => array('水灵使-艾莉娅 ★3','☆四星认证☆'),'result' => array('凭依装着-艾莉娅 ★4','WC',150,'80','ij'),),
	array('class' => 'ocg', 'stuff' => array('火灵使-希塔 ★3','☆四星认证☆'),'result' => array('凭依装着-希塔 ★4','WC04',150,'80','uj'),),
	array('class' => 'ocg', 'stuff' => array('风灵使-薇茵 ★3','☆四星认证☆'),'result' => array('凭依装着-薇茵 ★4','WC04',150,'80','cj'),),
	array('class' => 'ocg', 'stuff' => array('暗灵使-达克 ★3','☆四星认证☆'),'result' => array('凭依装着-达克 ★4','WC04',150,'80','pj'),),
	array('class' => 'ocg', 'stuff' => array('地灵使-奥丝 ★3','☆四星认证☆'),'result' => array('凭依装着-奥丝 ★4','WC04',150,'80','wj'),),
	array('class' => 'ocg', 'stuff' => array('光灵使-莱娜 ★3','☆四星认证☆'),'result' => array('凭依装着-莱娜 ★4','WC04',150,'80','ej'),),
	array('class' => 'ocg', 'stuff' => array('始祖守护者 提拉斯 ☆5 -仮','☆五星认证☆'),'result' => array('始祖守护者 提拉斯 ☆5','WC',240,'∞','epwi'),),
	array('class' => 'ocg', 'stuff' => array('流星龙 ★10 -仮','☆十星认证☆'),'result' => array('流星龙 ★10','WC10',600,'∞','crj'),),
	array('class' => 'ocg', 'stuff' => array('红莲魔龙 ★8 -仮','☆八星认证☆'),'result' => array('红莲魔龙 ★8','WC08',500,'80','cduCU'),),
	array('class' => 'ocg', 'stuff' => array('红莲魔龙 ★8','☆爆裂模式☆'),'result' => array('真红魔龙/爆裂体','WC10',250,'∞','cdZ'),),
	array('class' => 'ocg', 'stuff' => array('正义盟军 光明守望者 ★8 -仮','☆八星认证☆'),'result' => array('正义盟军 光明守望者 ★8','WC08',260,'∞','rZ'),),
	array('class' => 'ocg', 'stuff' => array('救世星龙 -仮','★神卡认证★','★神卡认证★'),'result' => array('「救世星龙」','WC',10000,'∞','dmcrZ'),),
	...
	array('class' => 'hidden', 'stuff' => array('面包','矿泉水','女生校服'),'result' => array('无垢的荣耀','A',1,1,Z),),
	array('class' => 'hidden', 'stuff' => array('面包','矿泉水','男生校服'),'result' => array('无垢的荣耀','A',1,1,Z),),
