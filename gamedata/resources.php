...
$clubinfo = Array(0=>'无',1=>'铁拳无敌',2=>'见敌必斩',3=>'灌篮高手',4=>'狙击鹰眼',5=>'拆弹专家',6=>'宛如疾风',7=>'锡安成员',8=>'黑衣组织',9=>'超能力者',10=>'高速成长', 11=>'富家子弟',12=> '全能骑士',13=> '根性兄贵' ,14=>'肌肉兄贵',15=>'<span class="red"><font style="background:url(http://dts.acfun.cn/img/backround4.gif) repeat-x">L5状态</font></span>',16=>'冥土追魂',17=>'走路萌物');
...
$typeinfo = Array(0=>'参战者',1=>'董事长',2=>'全息幻象',3=>'各路党派',4=>'非作战人员',5=>'代码聚合体',6=>'黑幕',7=>'首席执行官',8=>'管理员',9=>'活动盔甲',10=>'科学监察官',11=>'真职人');
$killmsginfo = Array(0=>'',1=>'你还不懂得运用你的力量，咱为此感到惋惜。',2=>'猎杀任务执行中。',3=>'你弱爆了！',4=>'啊……对不起！对不起！',5=>'记住，轻敌可是会死的。',6=>'忘记历史就意味着背叛，背叛就意味着……死亡。',7=>'你的实力还远远不及董事长的脚根呢。',8=>'死吧。',9=>'Let the darkness DIE!!',10=>'这是我必须做的事，给您添麻烦了……',11=>'看看职人的力量！');
$lwinfo = Array(
	0 => '',
	1 => '呜……这个躯体……咱还是无法自由运用啊……',
	2 => '机体受损过重，任务被迫中止。',
...
$npcchat = Array(
	...
	10 => Array(
		...
		'斯特鲁加茨基娅博士' => Array(
			...
			10 => '“突然袭击呢，很快我们会再会的。”',
			11 => '“射程不足？……怎么会发生这种事？”',
			12 => '斯特鲁加茨基娅博士的身后，展开了蝙蝠的羽翼！<br>“就让你，被牢牢锁死在这濒死的幻想世界里吧，一直到世界崩坏的那一刻……”',
...
$areainfo = Array
	...
	26=>"代表光与暗的战士们曾经的战场。<BR>现在只剩下他们的武器，无声地诉说着战争的结局。<br><span class=\"yellow\">地上竟然躺着上百具尸体！还是快逃跑吧！</span><br>",
