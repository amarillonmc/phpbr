...
$infinfo = Array('b' => '胸', 'h' => '头', 'a' => '腕', 'f' => '足', 'p' => '毒', 'u' => '烧', 'i' => '冻');
$attinfo = Array('N' => '徒手殴打', 'P' => '殴打','K' => '斩刺', 'G' => '射击', 'C' => '投掷', 'D' => '拉开引线投掷', 'F' => '释放灵力攻击');
...
$exdmgname = Array('p' => '毒性攻击', 'u' => '火焰燃烧', 'i'=>'冻气缠绕');
$exdmginf = Array('p' => '<span class="purple">中毒</span>', 'u' => '<span class="yellow">烧伤</span>', 'i'=>'<span class="clan">冻结</span>');
