...
<? if($itms1 && ((strpos($itmk1,'P') === 0) || (strpos($itmk1,'H') === 0))) { ?>
<input type="radio" name="command" id="chkp1" value="chkp1"><a onclick=sl('chkp1'); href="javascript:void(0);" ><?=$itm1?> </a><br>
<? } if($itms2 && ((strpos($itmk2,'P') === 0) || (strpos($itmk2,'H') === 0))) { ?>
<input type="radio" name="command" id="chkp2" value="chkp2"><a onclick=sl('chkp2'); href="javascript:void(0);" ><?=$itm2?> </a><br>
<? } if($itms3 && ((strpos($itmk3,'P') === 0) || (strpos($itmk3,'H') === 0))) { ?>
<input type="radio" name="command" id="chkp3" value="chkp3"><a onclick=sl('chkp3'); href="javascript:void(0);" ><?=$itm3?> </a><br>
<? } if($itms4 && ((strpos($itmk4,'P') === 0) || (strpos($itmk4,'H') === 0))) { ?>
