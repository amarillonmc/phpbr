...
(
	...
	'license' => '
	<p class="subtitle">生存游戏 BRA中文版授权协议 适用于中文用户。<br>
	本游戏版权属 龙游网/冴月麟/其他本版本大逃杀的改造者等 共同所有<br>
	，未经允许不得用于任何商业用途。
	<b>在单机服务器上安装常磐大逃杀的特殊附加条件</b><br>
在你执行安装程序的那个瞬间，你已经同意为大逃杀的开发做出精神和/或物质上的贡献。<br>
并且无条件同意在各种情况下，将会无条件强制被冴月麟或者其他大逃杀程序员征用为苦力或者其他大逃杀相关工作事宜人员。<br>
同意了以上条件后，你可以在单机上安装大逃杀。否则请关闭安装脚本，然后删除本脚本。<br>
<br>
如果你拥有服务器，则不需要遵循上述额外条件。<br>
此额外条件用于限制部分玩家利用单机版而对其他玩家造成不公正之可能性。<br>
	</p>',
